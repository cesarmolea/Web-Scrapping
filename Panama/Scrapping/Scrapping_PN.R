...
date <- seq(ymd("2010-01-01"), ymd("2019-12-30"), by = "days")
...
new_path <- "C:/Users/CESARMO/OneDrive - Inter-American Development Bank Group/ML course/NLP/Panama/Scrapping/docs"

for (i in 1:length(url)) { 
  destinations[i] <- paste0(new_path, "/", substr(url[i], 92, 101), ".pdf")
} 
